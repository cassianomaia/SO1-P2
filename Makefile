...
_%: %.o $(ULIB)
	...
	#TASK 2 
	#É necessário também, colocar o tamanho da primeira paginação no endereço do segmento texto ao invés de 0
	#para que todos os segmentos de texto comecem a ser endereçados a partir da segunda página.
