...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1047:	e8 0b 03 00 00       	call   1357 <unlink>
    ...
    1066:	c7 44 24 04 67 18 00 	movl   $0x1867,0x4(%esp)
    106d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1420:	0f b6 80 cc 2a 00 00 	movzbl 0x2acc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    157d:	75 09                	jne    1588 <printf+0x101>
          s = "(null)";
    157f:	c7 45 f4 80 18 00 00 	movl   $0x1880,-0xc(%ebp)
        while(*s != 0){
...
0000163a <free>:
    ...
    1649:	a1 e8 2a 00 00       	mov    0x2ae8,%eax
    ...
    1714:	a3 e8 2a 00 00       	mov    %eax,0x2ae8
    1719:	c9                   	leave  
    171a:	c3                   	ret    
...
0000171b <morecore>:
    ...
    176c:	a1 e8 2a 00 00       	mov    0x2ae8,%eax
    1771:	c9                   	leave  
    1772:	c3                   	ret    
...
00001773 <malloc>:
    ...
    1788:	a1 e8 2a 00 00       	mov    0x2ae8,%eax
    178d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1790:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1794:	75 23                	jne    17b9 <malloc+0x46>
    1796:	c7 45 f0 e0 2a 00 00 	movl   $0x2ae0,-0x10(%ebp)
    179d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    17a0:	a3 e8 2a 00 00       	mov    %eax,0x2ae8
    17a5:	a1 e8 2a 00 00       	mov    0x2ae8,%eax
    17aa:	a3 e0 2a 00 00       	mov    %eax,0x2ae0
    17af:	c7 05 e4 2a 00 00 00 	movl   $0x0,0x2ae4
    17b6:	00 00 00 
